<template>
  <q-page padding>
    ...
    <div class="row items-center justify-center">
      <div class="col-4">
        <h3 class="text-weight-bold small"> <em>Building a <br> Blockchain <br> Community</em> </h3>
      </div>
      <div class="col-8">
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
            <img class="shadow-24" alt="co love logo" width="100%" src="~/assets/Colorado-Love-Flag-1350-x-900.png">
      </div>
    </div>
